      ...
      <Card>
        <div className="Dashboard">
          <div className="container">
            <Row>
              <Col xs="4" sm="3">
                <Button onClick={showGraph} outline color="primary">
                  Time slot
                </Button>
              </Col>
              <Col xs="4" sm="6">
